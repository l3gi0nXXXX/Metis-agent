import SHARED_TOOL_DISPLAY_JSON from "../metis-runtime/apps/shared/MetisKit/Sources/MetisKit/Resources/tool-display.json" with { type: "json" };
import {
  defaultTitle,
...
} from "../metis-runtime/agents/tool-display-common.js";
