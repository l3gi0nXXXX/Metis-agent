import { formatDurationHuman } from "../metis-runtime/infra/format-time/format-duration.ts";
import { formatRelativeTimestamp } from "../metis-runtime/infra/format-time/format-relative.ts";
import { stripAssistantInternalScaffolding } from "../metis-runtime/shared/text/assistant-visible-text.js";
